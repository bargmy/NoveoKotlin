...
val appVersionCode = providers.gradleProperty("NOVEO_VERSION_CODE").orNull?.toIntOrNull() ?: 22
val appVersionName = providers.gradleProperty("NOVEO_VERSION_NAME").orNull ?: "0.7.0"
